...
using Tensee.Banch.DemoUiComponents.Dto;

namespace Tensee.Banch.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : BanchAppServiceBase, IDemoUiComponentsAppService
    {
