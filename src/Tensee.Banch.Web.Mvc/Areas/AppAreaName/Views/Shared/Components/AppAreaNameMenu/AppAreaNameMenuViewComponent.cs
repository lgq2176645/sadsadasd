...
using Tensee.Banch.Web.Theme;
using Tensee.Banch.Web.Views;

namespace Tensee.Banch.Web.Areas.AppAreaName.Views.Shared.Components.AppAreaNameMenu
{
    public class AppAreaNameMenuViewComponent : BanchViewComponent
    {
