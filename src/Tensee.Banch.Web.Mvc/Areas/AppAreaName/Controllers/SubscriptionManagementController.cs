...
using Tensee.Banch.Web.Areas.AppAreaName.Models.Editions;
using Tensee.Banch.Web.Areas.AppAreaName.Models.SubscriptionManagement;
using Tensee.Banch.Web.Controllers;
using Tensee.Banch.Web.Session;
using PaymentViewModel = Tensee.Banch.Web.Models.Payment.PaymentViewModel;

namespace Tensee.Banch.Web.Areas.AppAreaName.Controllers
{
    [Area("AppAreaName")]
    [AbpMvcAuthorize(AppPermissions.Pages_Administration_Tenant_SubscriptionManagement)]
    public class SubscriptionManagementController : BanchControllerBase
    {
