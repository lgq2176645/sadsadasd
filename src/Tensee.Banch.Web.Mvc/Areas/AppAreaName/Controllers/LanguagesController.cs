...
using Tensee.Banch.Web.Areas.AppAreaName.Models.Languages;
...
namespace Tensee.Banch.Web.Areas.AppAreaName.Controllers
{
    ...
    public class LanguagesController : BanchControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = BanchConsts.LocalizationSourceName;
            }
