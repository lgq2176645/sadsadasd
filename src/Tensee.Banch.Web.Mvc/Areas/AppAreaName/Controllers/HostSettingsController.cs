...
using Tensee.Banch.Configuration.Host;
using Tensee.Banch.Editions;
using Tensee.Banch.Timing;
using Tensee.Banch.Timing.Dto;
using Tensee.Banch.Web.Areas.AppAreaName.Models.HostSettings;
...
namespace Tensee.Banch.Web.Areas.AppAreaName.Controllers
{
    ...
    public class HostSettingsController : BanchControllerBase
    {
