...
using Tensee.Banch.Web.Public.Startup;
using Tensee.Banch.Web.Session;

namespace Tensee.Banch.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : BanchViewComponent
    {
