...
namespace Tensee.Banch.Web.Public.Startup
{
    [DependsOn(
        typeof(BanchWebCoreModule)
    )]
    public class BanchWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public BanchWebFrontEndModule(IHostingEnvironment env, BanchEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(BanchWebFrontEndModule).GetAssembly());
        }
    }
}
