...
namespace Tensee.Banch.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : BanchServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Tensee.Banch", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
