...
namespace Tensee.Banch.Web.Controllers.Handlers
{
    public class UploadHandler : Handler
    {
        ...
        public UploadHandler(HttpContext context, UploadConfig config, string webRootPath)
            : base(context)
        {
            UploadConfig = config;
        ...
        public override ContentResult Process()
        {
            ...
            var localPath = Path.Combine(WebRootPath, savePath.Replace('/', Path.DirectorySeparatorChar));
            try
            {
